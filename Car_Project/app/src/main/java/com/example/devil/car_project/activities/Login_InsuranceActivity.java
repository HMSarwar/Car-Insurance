...
public class Login_InsuranceActivity extends AppCompatActivity implements android.view.View.OnClickListener {
    private final AppCompatActivity activity = Login_InsuranceActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_insurance);
