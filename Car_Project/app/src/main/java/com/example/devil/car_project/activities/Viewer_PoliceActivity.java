...
public class Viewer_PoliceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewer_police);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.appCompatButtonSubmit:
                ...
                Intent intent = new Intent(getApplicationContext(), PoliceViewActivity.class);
