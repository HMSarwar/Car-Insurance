...
public class Viewer_InsuranceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewer_insurance);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.appCompatButtonSubmit:
                ...
                Intent intent = new Intent(getApplicationContext(), InsuranceViewActivity.class);
